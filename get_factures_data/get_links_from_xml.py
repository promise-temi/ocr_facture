...
with open('ocr_facture/get_factures_data/factures.xml', 'w') as file:
...
factures_links = []
tree = ET.parse('ocr_facture/get_factures_data/factures.xml')
root = tree.getroot()
...
with open('ocr_facture/get_factures_data/factures_links.txt','w') as file:
