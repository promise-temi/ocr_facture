...
with open('data/factures.xml', 'w') as file:
...
factures_links = []
tree = ET.parse('data/factures.xml')
root = tree.getroot()
...
with open('data/factures_links.json','w') as file:
    factures_links_dict = {"factures_links" : factures_links}
    file.write(json.dumps(factures_links_dict))
